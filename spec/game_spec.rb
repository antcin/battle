...
describe Game do
  ...
  let(:player1) { double :player, heart_points: 60 }
  let(:player2) { double :player, heart_points: 60 }
  let(:dead_player) { double :player, heart_points: 0 }
  ...
  describe '#game_over?' do
    it 'returns false if nobody is at 0HP' do
